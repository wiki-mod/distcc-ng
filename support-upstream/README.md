...
| 56 | [#275](https://github.com/wiki-mod/distcc-ng/issues/275) | not yet implemented | [Pump mode's include server can't see through a `ccache` wrapper (`compiler = args[0]`)](issue-442-pump-ccache-wrapper.md) | Still present in upstream's live source, unreported (related discussion in open distcc/distcc#230, distinct problem) |
