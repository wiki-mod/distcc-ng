...
main_having_files="distcc h_argvtostr h_compile h_dopt h_dotd h_exten h_fs_jail h_jail_containment h_getline h_hosts h_includesort h_issource h_parsemask h_pathsafety h_sa2str h_scanargs h_srvrpc h_ssh h_state h_stats h_strip lsdistcc mon-gnome mon-text history renderer"
