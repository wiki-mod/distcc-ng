...
Concrete example > abstract description where possible. -->

## What This PR Fixes / Adds
<!-- The specific bug, gap, or feature this addresses. If this is a partial/scoped fix, say so explicitly and
name what's intentionally deferred (with a Refs link to the follow-up issue if one exists). -->

## What Changed In Code
<!-- File-by-file or area-by-area: what actually changed, briefly. Not a restatement of the diff --
call out anything non-obvious a reviewer should know before reading the diff itself. -->

## Why This Matters For Users
<!-- distcc-ng distributes compilation across machines (client, distccd server, and optionally the pump
include-server). Explain the user/operator-visible consequence of the bug/gap this closes, or of NOT
merging this PR -- not just the technical mechanism. -->
...
deliberately NOT touched, say so and why. -->
...
## Validation
<!-- Exact commands run, not just "tested it works". Typical distcc-ng validation:
./autogen.sh && ./configure && make && make check
Note any check that could NOT be run and why (e.g. platform-specific test skipped). -->
