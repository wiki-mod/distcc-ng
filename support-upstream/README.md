...
| 57 | [#460](https://github.com/wiki-mod/distcc-ng/issues/460) | this PR | [Test-fixture file writes never closed before an external subprocess reads them back (whole-file sweep)](issue-460-testdistcc-unclosed-write-sweep.md) | Still present in upstream's live source at all six cited call sites, unreported |
