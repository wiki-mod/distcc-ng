...
| 57 | none filed (Issue #460 Finding 3) | [#466](https://github.com/wiki-mod/distcc-ng/pull/466) | [Test-fixture file write is never closed before a subprocess reads it back](issue-testdistcc-unclosed-write-before-subprocess-read.md) | Still present in upstream's live source (`BinFalse_Case`/`BinTrue_Case`), unreported |
