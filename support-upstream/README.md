...
| 29 | [#143](https://github.com/wiki-mod/distcc-ng/issues/143) | [#249](https://github.com/wiki-mod/distcc-ng/pull/249) | [Unbounded sprintf from caller-controlled input in lsdistcc `generate_query()` and the masquerade PATH idiom (`climasq.c`/`util.c`)](issue-143-lsdistcc-masquerade-unbounded-sprintf.md) | Still present in upstream's live source, unreported |
