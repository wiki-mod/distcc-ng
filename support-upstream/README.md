...
| 57 | none filed (Issue #460 Finding 3) | [#466](https://github.com/wiki-mod/distcc-ng/pull/466) | [Test-fixture file write is not explicitly closed before the next test step](issue-testdistcc-unclosed-write-before-subprocess-read.md) | Still present in upstream's live source (`BinFalse_Case`/`BinTrue_Case`), unreported |
